...
def get_class_counts(dataset: MEEIDataset, num_classes: int = 6) -> torch.Tensor:
...
def main():
    ...
    train_dataset = MEEIDataset(PAR_PATH, "train", transform)
    val_dataset = MEEIDataset(PAR_PATH, "val", transform)
