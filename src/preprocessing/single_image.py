...
DEFAULT_OUT_PARQUET = MAN_DIR / "training_manifest_single_images.parquet"
DEFAULT_OUT_CSV = MAN_DIR / "training_manifest_single_images.csv"
...
def build_image_manifest(df: pd.DataFrame) -> pd.DataFrame:
    image_df = df[df["pose_index"] == IMAGE_IDX].copy()
